...
import '../Css/CardSlider.css'; // Sus nuevos estilos

// Importa las 6 imágenes de tus productos
import pcacer from '../assets/imagenesproductos/computadores/pcescritorio/acer.png';
import i16 from '../assets/imagenesproductos/celulares/iphone16.png';
import r14 from '../assets/imagenesproductos/celulares/redmi14.png'; // <- Imagen nueva
...
const ProductGrid = () => {
  return (
    <div className="product-grid">
      ...
      <section className="product-card light-card">
      ...
      {/* Producto 2: iPad Pro */}
      <section className="product-card dark-card">
        <div className="product-content">
