...
const Registro = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { nombre, tipoDoc, numeroDoc, telefono, correo, direccion, pass, confirmPass } = formData;

    // 3. ACTUALIZAMOS LA VALIDACIÓN DE CAMPOS VACÍOS
    if (!nombre || !tipoDoc || !numeroDoc || !telefono || !correo || !direccion || !pass || !confirmPass) {
